...
public class PruebaHashExploraciones_2024_25_retroalimentacion {
	...
	public void sesion13Test() {
		...
		try
		{
			file = new FileWriter(al.getNombreFicheroAlumno()+"-Hash-Exploraciones.txt",false);
	...
	private void pruebaBasicaCuadratica(PrintWriter pw) {
		ClosedHashTable<Integer> h = new ClosedHashTable<>(11, ClosedHashTable.CUADRATICA);
		
		int operacion=0;
		
		pw.println("Empieza la prueba cuadratica sin dispersion de Hash: ");
		System.out.println("Empieza la prueba cuadratica sin dispersion de Hash: ");
		pw.println("h=new ClosedHashTable<Integer>(5,ClosedHashTable.CUADRATICA): ");
		System.out.println("h=new ClosedHashTable<Integer>(5,ClosedHashTable.CUADRATICA): ");
		...
		pw.println("Termina la prueba cuadratica sin dispersion de Hash.\n");
		System.out.println("Termina la prueba cuadratica sin dispersion de Hash.\n");
	}	

	private void pruebaBasicaDobleHash(PrintWriter pw) {
		ClosedHashTable<Integer> h = new ClosedHashTable<>(11, ClosedHashTable.DOBLEHASH);
		
		int operacion=0;
		
		pw.println("Empieza la prueba otras exploraciones sin dispersion de Hash: ");
		System.out.println("Empieza la prueba otras exploraciones sin dispersion de Hash: ");
		pw.println("h=new ClosedHashTable<Integer>(5,ClosedHashTable.DOBLEHASH): ");
		System.out.println("h=new ClosedHashTable<Integer>(5,ClosedHashTable.DOBLEHASH): ");
		...
		pw.println("Termina la prueba otras exploraciones sin dispersion de Hash.\n");
		System.out.println("Termina la prueba otras exploraciones sin dispersion de Hash.\n");
	}	
}
